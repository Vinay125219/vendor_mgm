import{b as i,l as a,d}from"./client-store.D3j3rl_c.js";import{f as c}from"./format.BVwlPILG.js";function m(t){return d.find(s=>s.id===t)?.businessName??t}function r(){const t=document.getElementById("vs-ticket-list");if(!t)return;const s=a().tickets;t.innerHTML=s.map(e=>`
      <li class="flex flex-wrap items-center justify-between gap-3 py-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="text-xs text-vs-muted">${c(e.updatedAt)}</span>
        </div>
