...
import 'piccolore';
import { v as createRenderInstruction, m as maybeRenderHead, h as addAttribute, r as renderTemplate, l as renderComponent, p as renderSlot, o as renderHead } from './entrypoint_CV8pRvJF.mjs';
import { V as VENDOR_BASE_PATH, A as APP_NAME } from './constants_CvXk3xLY.mjs';
import 'clsx';
...
const $$VendorShell = createComponent(($$result, $$props, $$slots) => {
  ...
  const { title, description = "Operations cockpit" } = Astro2.props;
  const path = Astro2.url.pathname;
  const seedUnread = mockNotifications.filter((n) => !n.read).length;
  let currentNav = vendorNav;
  let workspaceTitle = "Vendor Portal";
...
export { $$VendorShell as $, $$PageHeader as a, mockVendors as b, mockProducts as c, mockNotifications as d, mockOrders as e, mockWebhookLog as f, mockPayments as g, mockSettlements as h, mockActivities as i, mockComplianceAlerts as j, mockAuditLog as k, mockTickets as l, mockDisputes as m, renderScript as r };
